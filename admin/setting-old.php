                  ...
                  <div class="x_content">
                    ...
                    <form method="post" action="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
                     ...
                     if(empty($row['phone_no']))
                     {
                      ...
                      ?>
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Laundary
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <p>
                        <input type="radio" class="flat" name="laundary" id="genderM" value="1"  /> Yes &nbsp;&nbsp;&nbsp;
                       <input type="radio" class="flat" name="laundary" id="genderF" value="0"  checked /> No
                        </p>
                        </div>
                        </div>
                        <?php } 
                        ...
                        <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Internet Connection
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <p>
                        <input type="radio" class="flat" name="internet" id="genderM" value="1" /> Yes &nbsp;&nbsp;&nbsp;
                       <input type="radio" class="flat" name="internet" id="genderF" value="0"  checked /> No
                        </p>
                        </div>
                        </div>
                        <?php } 
                        ...
                        ?>
                        <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Generator
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <p>
                        <input type="radio" class="flat" name="genrator" id="genderM" value="1" /> Yes &nbsp;&nbsp;&nbsp;
                       <input type="radio" class="flat" name="genrator" id="genderF" value="0"  checked /> No
                        </p>
                        </div>
                        </div>
                        <?php } 
                        ...
                        ?>
                         <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">TV
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <p>
                        <input type="radio" class="flat" name="tv" id="genderM" value="1" /> Yes &nbsp;&nbsp;&nbsp;
                       <input type="radio" class="flat" name="tv" id="genderF" value="0" checked /> No
                        </p>
                        </div>
                        </div>
                        <?php } 
                        ...
                        ?>
                         <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Guest Allowed Or Not
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <p>
                        <input type="radio" class="flat" name="guest" id="genderM" value="1" /> Yes &nbsp;&nbsp;&nbsp;
                       <input type="radio" class="flat" name="guest" id="genderF" value="0" checked /> No
                        </p>
                        </div>
                        </div>
                        <?php } 
...
<?php
  if(isset($_POST['update']))
  {
    ...
    if($laundary==0){ $laundary=$row['laundary']; }
    $internet=$_POST['internet'];
    if($internet==0){ $internet=$row['internet']; }
    $genrator=$_POST['genrator'];
    if($genrator==0){ $genrator=$row['genrator']; }
    $tv=$_POST['tv'];
    if($tv==0){ $tv=$row['tv']; }
    $guest=$_POST['guest'];
    if($guest==0){ $guest=$row['guest']; }
    $keyword=$_POST['keyword'];
    if(empty($keyword)){ $keyword=$row['keyword']; }

    $updateHostel="UPDATE `hostel` SET `phone_no`='$phone',`sec_fee`='$sec_fee',`add_fee`='$add_fee',`rules`='$rules',`laundary`='$laundary',`internet`='$internet',`genrator`='$genrator',`tv`='$tv',`guest`='$guest',`keyword`='$keyword' WHERE `id`='$id'";
   ...
   <table class="table table-hover">
        <tbody>
          <tr id="imgTr">
            ...
            <td><a href="updateImage.php"><i class="fa fa-pencil"></i></a></td>
          </tr>
          <tr id="name">
            <td class="tdH">Hostel Name: </td>
            <td id="divVal"><?php echo $row['name']; ?></td>
            <td><button class="b" onclick="showName('name','nameDiv')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          ...
          <tr id="roomTr">
            ...
            <td><button class="b" onclick="showName('roomTr','updateRoom')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateRoom">
            <td class="tdH">Total Room: </td>
          ...
          <tr id="phoneTr">
            ...
            <td id="PhoneTd"><?php echo $row['phone_no']; ?></td>
             <td><button class="b" onclick="showName('phoneTr','updatePhone')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updatePhone">
            <td class="tdH">Phone Number: </td>
          ...
          <tr id="mobileTr">
            ...
            <td><button class="b" onclick="showName('mobileTr','updateMobile')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateMobile">
            <td class="tdH">Mobile Number: </td>
          ...
          <tr id="emailTr">
            ...
            <td><button class="b" onclick="showName('emailTr','updateEmail')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateEmail">
            <td class="tdH">Email ID: </td>
          ...
          <tr id="hostelTr">
            ...
            <td><button class="b" onclick="showName('hostelTr','updateHostel')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateHostel">
            <td class="tdH">Hostel For: </td>
          ...
          <tr id="securityTr">
            ...
            <td><button class="b" onclick="showName('securityTr','updateSecurity')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          ...
          <tr id="addmissionTr">
            ...
            <td><button class="b" onclick="showName('addmissionTr','updateAddmission')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          ...
          <tr id="laundaryTr">
            ...
            <td><button class="b" onclick="showName('laundaryTr','updateLaundary')"><i class="fa fa-pencil"></i></button></td>
          </tr>
         ...
         <td><button onclick="update('laundary', 'updateLaundary', 'laundaryTr','laundaryTd','laundary')">Update</button></td>
          ...
          <tr id="internetTr">
            ...
            <td><button class="b" onclick="showName('internetTr','updateInternet')"><i class="fa fa-pencil"></i></button></td>
          </tr>
         ...
         <td><button onclick="update('internet', 'updateInternet', 'internetTr','internetTd','internet')">Update</button></td>
          ...
          <tr id="genTr">
            ...
            <td><button class="b" onclick="showName('genTr','updateGen')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateGen">
         ...
         <td><button onclick="update('genrator', 'updateGen', 'genTr','genTd','gen')">Update</button></td>
          ...
          <tr id="tvTr">
            ...
            <td><button class="b" onclick="showName('tvTr','updateTv')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateTv">
         ...
         <td><button onclick="update('tv', 'updateTv', 'tvTr','tvTd','tv')">Update</button></td>
          ...
          <tr id="guestTr">
            ...
            <td><button class="b" onclick="showName('guestTr','updateGuest')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateGuest">
          <td id="tdH">Guest</td>
          <td><div class="item form-group">
         ...
         <td><button onclick="update('guest', 'updateGuest', 'guestTr','guestTd','guest')">Update</button></td>
          ...
          <tr id="keyTr">
            ...
            <td><button class="b" onclick="showName('keyTr','updateKey')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateKey">
            <td class="tdH">Keyword: </td>
          ...
          <tr id="addTr">
            ...
            <td><button class="b" onclick="showName('addTr','updateAdd')"><i class="fa fa-pencil"></i></button></td>
          </tr>
          <tr id="updateAdd">
            <td class="tdH">Address: </td>
          ...
          <tr id="rulTr">
            ...
            <td><a href="updateRule.php"><i class="fa fa-pencil"></i></a></td>
          </tr>
