        ...
        <div class="col-sm-6 col-md-6" style="padding: 0px;">
            <div class="room" >
                <div class="room-img-content">
                    <img src="admin/images/<?php echo $image; ?>" class="img-responsive"  >
...
<?php         $host="SELECT * FROM hostel WHERE id=$get_id";
              $rnh=mysqli_query($con,$host);
              $res=mysqli_fetch_array($rnh);
              $loca=str_replace("(","",$res['location']);
...
<div class="col-sm-3 col-md-4" style="padding: 0px; margin-left: -10px;"><style>
 ...
 ?>
          <center><button type="button" onclick="submit()" class="blue-btn" style="margin-top: -40px;">Show Contact</button></center><?php } }else{
            $host="SELECT * FROM hostel WHERE id=$get_id";
              $rnh=mysqli_query($con,$host);
              $roh=mysqli_fetch_array($rnh);
              echo "Address: ".$roh['address'];
...
<?php if(isset($get_p_id)){ ?>
    ...
    <div class="col-sm-8 col-md-8" style="padding: 0px;">
    <?php 
       $qry="SELECT * FROM flats WHERE id=$get_p_id ";
